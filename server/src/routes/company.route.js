...
companyRouter.post("/register",authVerify,verifyPermission(userRoleEnums.ADMIN),registerCompany)
companyRouter.get("/",authVerify,getCompany)
companyRouter.put("/:id",authVerify,upload.single("logo"),verifyPermission(userRoleEnums.ADMIN),updateCompany)
